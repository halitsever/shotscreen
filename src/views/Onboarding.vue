  ...
  <div class="drag flex h-screen w-screen flex-col items-center justify-center bg-zinc-950 text-zinc-100">
    ...
    <div class="no-drag mb-10 text-center">
      ...
      <p class="mt-2 text-sm text-zinc-500">
        Take clean, beautiful screenshots of any website.
      </p>
    </div>
    ...
    <div class="no-drag mb-10 grid w-[420px] grid-cols-3 gap-3">
      <div
        ...
        :key="feature.title"
        class="flex flex-col gap-2 rounded-xl border border-zinc-800 bg-zinc-900/60 p-4"
      >
    ...
    <div class="no-drag flex flex-col items-center gap-3">
      <button
        class="rounded-md bg-zinc-100 px-8 py-2.5 text-sm font-medium text-zinc-900 shadow-sm transition-colors hover:bg-white"
        @click="start"
      >
        Get Started
      </button>
      <p class="text-[11px] text-zinc-600">
        You can always find these controls in the left sidebar.
      </p>
    </div>
